...
namespace jbboehr\PHPStanLostInTranslation\Collector;
 ...
 */
final class LostInTranslationFakeCollectorRule implements Rule
{
    public function __construct(
        private readonly LostInTranslationHelper $helper,
        private readonly LostInTranslationCollector $collector,
    ) {
    }
